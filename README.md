...
# What's News :
* support hirensboot, malekal, liveCD, Amoei Backup, Acronis
* check hash, and automaticly detect authenticity ISO version (not evaluation version)
* Add new language italia, Spanish
